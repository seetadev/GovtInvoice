...
//
   ...
   defaultGridCSS: "1px solid #D1D5DB;", // used as style to set each border when grid enabled (was #ECECEC)
   ...
   defaultHighlightTypeCursorStyle: "color:#FFF;backgroundColor:#bdbdbb;",
   defaultHighlightTypeRangeClass: "",
   defaultHighlightTypeRangeStyle: "color:#000;backgroundColor:#f6f7c1;",

   defaultColnameClass: "", // regular column heading letters, needs a cursor property 
   defaultColnameStyle: "font-size:small;text-align:center;color:#0a0a0a;background-color:#bebebe;cursor:e-resize;",
   defaultSelectedColnameClass: "", // column with selected cell, needs a cursor property 
   defaultSelectedColnameStyle: "font-size:small;text-align:center;color:#fcfcfc;background-color:#4CAF50;cursor:e-resize;",
   defaultRownameClass: "", // regular row heading numbers
   defaultRownameStyle: "font-size:small;text-align:right;color:#0a0a0a;background-color:#bebebe;",
   defaultSelectedRownameClass: "", // column with selected cell, needs a cursor property 
   defaultSelectedRownameStyle: "font-size:small;text-align:right;color:#fcfcfc;background-color:#4CAF50;",
   ...
   defaultSkippedCellStyle: "font-size:small;background-color:#2cc93c", // used if present
...
//
   ...
   SCToolbarbackground: "background-color:#2B579A;",
   SCTabbackground: "background-color:#2B579A;",
   SCTabselectedCSS: "font-size:small;padding:6px 30px 6px 8px;color:#0a0a0a;background-color:#e0dfdf;cursor:default;border-right:1px solid #CCC;",
   SCTabplainCSS: "font-size:small;padding:6px 30px 6px 8px;color:#ECF0F1;background-color:#2B579A;cursor:default;border-right:1px solid #8f8f8d;",
   SCToolbartext: "font-size:x-small;font-weight:bold;color:#2C3E50;padding-bottom:4px;",
   ...
   // workbook
    doWorkBook: true,
    SCSheetBarHeight: 25,
    SCSheetBarBackground: "background-color:#0a0a0a;",
