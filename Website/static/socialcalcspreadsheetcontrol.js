...
//            name: "sheet",
         ...
         viewobj.values.cellspanel = {
	       ...
	       initialdata: scc.SCFormatPadsizes},
            ceditable: {setting: "ceditable", type: "PopupList", id: s.idPrefix+"ceditable",
			initialdata: scc.SCFormatEditable},
	    constraints: {setting: "cconstraints", type: "PopupList", id: s.idPrefix+"cconstraints",
...
'</tr>'+
'<tr>'+
' <td %itemtitle.><br>%loc!Editable!:</td>'+
' <td %itembody.>'+
'   <table cellspacing="0" cellpadding="0"><tr>'+
'    <td %bodypart.>'+
'     <div %parttitle.>&nbsp;</div>'+
...
'</tr>'+
'<tr>'+
' <td %itemtitle.><br>%loc!Constraints!:</td>'+
' <td %itembody.>'+
'   <table cellspacing="0" cellpadding="0"><tr>'+
'    <td %bodypart.>'+
'     <div %parttitle.>&nbsp;</div>'+
